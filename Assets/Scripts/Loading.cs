...
public class Loading : MonoBehaviour
{
    ...
    [SerializeField] private Image egg;//egg
    private bool ready = false;
    private float speed = .7f;//for the fill speed of the egg
    ...
    void Update()
    {
        ...
        if (egg)
        {
            egg.fillAmount = Mathf.Lerp(egg.fillAmount, 1+egg.fillAmount, Time.deltaTime * speed);
            if (egg.fillAmount>=1)
            {
                egg.fillAmount = 0;
            }
